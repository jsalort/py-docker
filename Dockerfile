...
RUN cd /home/ubuntu && . /home/ubuntu/.local/bin/env && \
    ...
    uv venv --python 3.14 /home/ubuntu/.venv/py314

ENV VIRTUAL_ENV=/home/ubuntu/.venv/py314
ENV PKG_CONFIG_PATH=/home/ubuntu/.local/share/uv/python/cpython-3.14.6-linux-x86_64-gnu/lib/pkgconfig
RUN echo "source /home/ubuntu/.venv/py314/bin/activate" >> /home/ubuntu/.bashrc
ENV BASH_ENV="/home/ubuntu/.bashrc"
ENV OMP_NUM_THREADS="1"
ENV QT_QPA_PLATFORM="offscreen"
ENV XDG_RUNTIME_DIR="/tmp/runtime-ubuntu"
ENV PS1="(py314) \[\e]0;\u@\h: \w\a\]${debian_chroot:+($debian_chroot)}\u@\h:\w\$"
ENV PATH=/home/ubuntu/.venv/py314/bin:/home/ubuntu/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
ENV PATH=/usr/local/texlive/2025/bin/x86_64-linux:/home/ubuntu/.cargo/bin:/home/ubuntu/.venv/py314/bin:/home/ubuntu/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
RUN uv pip install git+https://github.com/scorpion81/pyvoro.git
RUN python -m pip install hg+https://foss.heptapod.net/fluiddyn/fluiddyn
RUN python -m pip install hg+https://foss.heptapod.net/fluiddyn/fluidlab
RUN python -m pip install hg+https://foss.heptapod.net/fluiddyn/fluidimage
